    ...
    def __init__(self, parent, text, data_var, min_value,max_value):
        ...
        ctk.CTkSlider(self, 
                    ...
                    #   command=self.update_text,
                      variable=self.data_var).grid(row = 1, column = 0, columnspan = 2, sticky = 'ew', padx= 5, pady = 5 )
...
class FilePathPanel(Panel):
    def __init__(self, parent, path_string):
        ...
        #add a button and a an entry field
        ...
        #the button should open a filedialog and the entry field should display the returned path
